...
function App() {
  ...
  return (
    <div className="min-h-screen bg-white text-gray-900">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center py-4">
            ...
            <nav className="hidden md:flex space-x-8">
              <a href="#home" className="text-gray-700 hover:text-amber-700 transition-colors duration-200 font-medium" style={{fontFamily: 'Poppins, sans-serif'}}>
                Home
              </a>
              <a href="#about" className="text-gray-700 hover:text-amber-700 transition-colors duration-200 font-medium" style={{fontFamily: 'Poppins, sans-serif'}}>
                About
              </a>
              <a href="#book" className="text-gray-700 hover:text-amber-700 transition-colors duration-200 font-medium" style={{fontFamily: 'Poppins, sans-serif'}}>
                The Book
              </a>
              <a href="#contact" className="text-gray-700 hover:text-amber-700 transition-colors duration-200 font-medium" style={{fontFamily: 'Poppins, sans-serif'}}>
                Contact
              </a>
            </nav>
            ...
            <div className="hidden md:block">
              <button className="bg-amber-700 hover:bg-amber-800 text-white px-6 py-2 rounded-lg font-semibold transition-colors duration-200 inline-flex items-center gap-2" style={{fontFamily: 'Poppins, sans-serif'}}>
          ...
          {isMenuOpen && (
            <div className="md:hidden border-t border-gray-200">
              <div className="py-4 space-y-4">
                <a href="#home" className="block text-gray-700 hover:text-amber-700 transition-colors duration-200 font-medium" style={{fontFamily: 'Poppins, sans-serif'}}>
                  Home
                </a>
                <a href="#about" className="block text-gray-700 hover:text-amber-700 transition-colors duration-200 font-medium" style={{fontFamily: 'Poppins, sans-serif'}}>
                  About
                </a>
                <a href="#book" className="block text-gray-700 hover:text-amber-700 transition-colors duration-200 font-medium" style={{fontFamily: 'Poppins, sans-serif'}}>
                  The Book
                </a>
                <a href="#contact" className="block text-gray-700 hover:text-amber-700 transition-colors duration-200 font-medium" style={{fontFamily: 'Poppins, sans-serif'}}>
                  Contact
                </a>
                <button className="w-full bg-amber-700 hover:bg-amber-800 text-white px-6 py-2 rounded-lg font-semibold transition-colors duration-200 inline-flex items-center justify-center gap-2" style={{fontFamily: 'Poppins, sans-serif'}}>
                  <ShoppingCart size={16} />
                  Buy Now
                </button>
              </div>
      ...
      {/* Hero Section */}
      <section id="home" className="relative bg-gradient-to-br from-amber-50 to-orange-50 py-16 px-4 sm:px-6 lg:px-8">
        <div className="max-w-7xl mx-auto">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="order-2 lg:order-1 text-center lg:text-left">
              ...
              <p className="text-lg sm:text-xl text-gray-700 mb-8 leading-relaxed max-w-xl mx-auto lg:mx-0" style={{fontFamily: 'Poppins, sans-serif'}}>
              ...
              <button className="bg-amber-700 hover:bg-amber-800 text-white px-8 py-4 rounded-lg text-lg font-semibold transition-colors duration-200 shadow-lg hover:shadow-xl transform hover:-translate-y-1 inline-flex items-center gap-2" style={{fontFamily: 'Poppins, sans-serif'}}>
      ...
      <section id="about" className="py-20 px-4 sm:px-6 lg:px-8 bg-white">
        <div className="max-w-4xl mx-auto">
          <h2 className="text-3xl sm:text-4xl font-bold text-center text-gray-900 mb-12" style={{fontFamily: 'Playfair Display, serif'}}>
            About the Author
          </h2>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 items-center">
            ...
            <div className="md:col-span-2 text-center md:text-left">
              <h3 className="text-2xl font-semibold text-gray-900 mb-4" style={{fontFamily: 'Playfair Display, serif'}}>
                Sarah Mitchell
              </h3>
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <div>
              ...
              <p className="text-gray-700 leading-relaxed mb-8" style={{fontFamily: 'Poppins, sans-serif'}}>
